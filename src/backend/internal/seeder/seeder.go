	...
	polls := []types.Poll{
		{
			...
			StartTime:            &now,
			AccessStructureType:  types.AccessStructureBoth,
			MinAuditorsRequired:  1,
			MinOfficialsRequired: 2,
			CreatedAt:            nowStr,
			UpdatedAt:            nowStr,
			Version:              1,
		},
		{
			...
			AccessStructureType:  types.AccessStructureOfficialsOnly,
			MinOfficialsRequired: 2,
			CreatedAt:            nowStr,
			UpdatedAt:            nowStr,
			Version:              1,
		},
		{
			...
			Status:               types.PollStatusOpen,
			StartTime:            &now,
			AccessStructureType:  types.AccessStructureAuditorsOnly,
			MinAuditorsRequired:  2,
			CreatedAt:            nowStr,
			UpdatedAt:            nowStr,
			Version:              1,
		},
